...
export const FETCH_ADMIN_FACILITY_LIST_ACTIVE_REQUEST = "FETCH_ADMIN_FACILITY_LIST_ACTIVE_REQUEST";
export const FETCH_ADMIN_FACILITY_LIST_ACTIVE_SUCCESS = "FETCH_ADMIN_FACILITY_LIST_ACTIVE_SUCCESS";
export const FETCH_ADMIN_FACILITY_LIST_ACTIVE_FAILURE = "FETCH_ADMIN_FACILITY_LIST_ACTIVE_FAILURE";

export const FETCH_ADMIN_FACILITY_LIST_INPROCESS_REQUEST = "FETCH_ADMIN_FACILITY_LIST_INPROCESS_REQUEST";
export const FETCH_ADMIN_FACILITY_LIST_INPROCESS_SUCCESS = "FETCH_ADMIN_FACILITY_LIST_INPROCESS_SUCCESS";
export const FETCH_ADMIN_FACILITY_LIST_INPROCESS_FAILURE = "FETCH_ADMIN_FACILITY_LIST_INPROCESS_FAILURE";
...
export const ADMIN_ADD_FACILITY_DOCUMENT_REQUEST = "ADMIN_ADD_FACILITY_DOCUMENT_REQUEST";
export const ADMIN_ADD_FACILITY_DOCUMENT_SUCCESS = "ADMIN_ADD_FACILITY_DOCUMENT_SUCCESS";
export const ADMIN_ADD_FACILITY_DOCUMENT_FAILURE = "ADMIN_ADD_FACILITY_DOCUMENT_FAILURE";
...
export const CHANGE_COMPANY_SUPER_ADMIN_REQUEST = "CHANGE_COMPANY_SUPER_ADMIN_REQUEST"
export const CHANGE_COMPANY_SUPER_ADMIN_SUCCESS = "CHANGE_COMPANY_SUPER_ADMIN_SUCCESS"
export const CHANGE_COMPANY_SUPER_ADMIN_FAILURE = "CHANGE_COMPANY_SUPER_ADMIN_FAILURE"

export const FETCH_COMPANY_USER_LIST_REQUEST = "FETCH_COMPANY_USER_LIST_REQUEST";
export const FETCH_COMPANY_USER_LIST_SUCCESS = "FETCH_COMPANY_USER_LIST_SUCCESS";
export const FETCH_COMPANY_USER_LIST_FAILURE = "FETCH_COMPANY_USER_LIST_FAILURE";
...
//---------------------------------BASELINE TYPES--------------------------------
export const ADMIN_SUFFICIENCY_CHECK_REQUEST = "ADMIN_SUFFICIENCY_CHECK_REQUEST";
export const ADMIN_SUFFICIENCY_CHECK_SUCCESS = "ADMIN_SUFFICIENCY_CHECK_SUCCESS";
export const ADMIN_SUFFICIENCY_CHECK_FAILURE = "ADMIN_SUFFICIENCY_CHECK_FAILURE";

export const ADMIN_INDEPENDENT_VARIABLE_LIST_REQUEST = "ADMIN_INDEPENDENT_VARIABLE_LIST_REQUEST";
export const ADMIN_INDEPENDENT_VARIABLE_LIST_SUCCESS = "ADMIN_INDEPENDENT_VARIABLE_LIST_SUCCESS";
export const ADMIN_INDEPENDENT_VARIABLE_LIST_FAILURE = "ADMIN_INDEPENDENT_VARIABLE_LIST_FAILURE";

export const FETCH_ADMIN_BASELINE_PERIOD_REQUEST = "FETCH_ADMIN_BASELINE_PERIOD_REQUEST";
export const FETCH_ADMIN_BASELINE_PERIOD_SUCCESS = "FETCH_ADMIN_BASELINE_PERIOD_SUCCESS";
export const FETCH_ADMIN_BASELINE_PERIOD_FAILURE = "FETCH_ADMIN_BASELINE_PERIOD_FAILURE"

export const FETCH_ADMIN_STATIONS_DETAILS_REQUEST = "FETCH_ADMIN_STATIONS_DETAILS_REQUEST";
export const FETCH_ADMIN_STATIONS_DETAILS_SUCCESS = "FETCH_ADMIN_STATIONS_DETAILS_SUCCESS";
export const FETCH_ADMIN_STATIONS_DETAILS_FAILURE = "FETCH_ADMIN_STATIONS_DETAILS_FAILURE";
