 ...
 */
console.log("process.env 13th May 2024, 12:00 PM", process.env.REACT_APP_AZURE_ENV)
export const msalConfig = {
    auth: {
        ...
        postLogoutRedirectUri: '/?postLogout=true', // Indicates the page to navigate after logout.
