    ...
    >
      <StyledContentWrapper>
          ...
          <Typography sx={{ fontSize: "0.875rem" }}>
            The Participant (being the “Applicant” in the Application) has
            applied for Performance Incentives, in respect of electricity
            savings achieved at one or more Facilities through operational and
            maintenance energy efficiency measures and equipment retrofits,
            pursuant to the Application submitted to the IESO under the Save on
            Energy - Energy Performance Program (the “EPP” or the “Program”) in
            accordance with the Program Requirements. All capitalized terms not
            defined herein will have the meanings given to them in Schedule A to
            this Agreement. In consideration of the Performance Incentives being
            provided and other good and valuable consideration the receipt and
            sufficiency of which are hereby acknowledged, the Participant agrees
          ...
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
            ...
            <Typography variant="inherit" sx={{ pl: 1 }}>
              ...
              detailing the Facility which has been approved by the IESO and
              such additional information as prescribed by IESO to substantiate
              the payment.
            </Typography>
          </Box>
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
          ...
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
            ...
            <Typography variant="inherit" sx={{ pl: 1 }}>
              ...
              whether arising before or after the expiration or termination of
          ...
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
            ...
            <Typography variant="inherit" sx={{ pl: 1 }}>
              ...
              days thereafter, an Arbitrator will be designated by a judge of
              the Ontario Superior Court of Justice upon application by either
              Party. The Arbitrator may determine all questions of law, fact and
              jurisdiction with respect to the dispute or the arbitration
              (including questions as to whether a dispute is arbitrable) and
              all matters of procedure relating to the arbitration. The
              Arbitrator may grant legal and equitable relief (including
              injunctive relief), award costs (including legal fees and the
              costs of the arbitration), and award interest.
            </Typography>
          </Box>
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
            <Typography variant="inherit" sx={{ fontWeight: 600 }}>
            ...
            <Typography variant="inherit" sx={{ pl: 1 }}>
              The arbitration will be conducted in English in the City of
              Toronto (unless otherwise agreed to by the Parties) at such place
              therein and time as the Arbitrator may fix and, failing agreement
              thereto by the Parties, in accordance with such procedures as the
              Arbitrator will determine, in accordance with the principles of
              natural justice. The arbitration and all matters arising directly
              or indirectly therefrom will be kept strictly confidential by the
          ...
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
            ...
            <Typography variant="inherit" sx={{ pl: 1 }}>
              ...
              hearing. The costs of any arbitration hereunder will be borne by
              the Parties in the manner specified by the Arbitrator in his or
              her decision. The decision of the Arbitrator will be final and
              ...
              the final determination of the issues in the arbitration. There
              will be no appeal from the decision of the Arbitrator to any
              court, except on the grounds that the conduct of the Arbitrator,
              or the decision itself, violated the provisions of the Arbitration
              Act, 1991 (Ontario), or solely on a question of law as provided
              for in such act. Judgment upon any award rendered by the
          ...
          <Box sx={{ display: "flex", fontSize: "0.875rem", mt: 2 }}>
            ...
            <Typography variant="inherit" sx={{ pl: 1 }}>
              Submission to arbitration under this Schedule “C” is intended by
              the Parties to preclude any action in matters which may be
              arbitrated hereunder, save and except for enforcement of any
              arbitral award hereunder.
            </Typography>
          </Box>
      </StyledContentWrapper>
    </Box>
