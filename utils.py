...
def save_file_to_blob(blob_name, file):
    try:
        ...
        # Reset the file pointer to the beginning if it's a FileStorage object
        ...
        blob_client.upload_blob(file_content, overwrite=True)  # Consider setting overwrite based on your requirements
