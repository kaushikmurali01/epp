...
ERROR_UPLOADER_INTIMATION_METER = """UPDATE epp.facility_meter_hourly_entries SET processed = null WHERE id={} """
ERROR_UPLOADER_INTIMATION_IV = """UPDATE epp.independent_variable_file SET processed = null WHERE id={} """
