...
# def get_data_cleaning_query(temp1, temp2, temp3, start_date, end_date, facility_id, meter_type, independent_variables=()):
#     where_condition = f"AND meter_type = {meter_type}"
#     if independent_variables:
#         where_condition = f"AND (meter_type = {meter_type} or independent_variable in {independent_variables})"
#     return f"""
#     WITH base_data AS (
#         SELECT DATE_TRUNC('hour', start_date::timestamp) AS start_date,
#                CASE
