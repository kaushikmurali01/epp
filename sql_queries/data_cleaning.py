...
def get_data_cleaning_query(temp1, temp2, temp3, start_date, end_date, facility_id, meter_type, temp_start, temp_end):
    ...
    WHERE station_id IN ({temp1}, {temp2}, {temp3})
      AND utc_start_date BETWEEN '{temp_start}' AND '{temp_end}'
),
averaged_data AS (
    SELECT start_date, 
           meter_id, 
