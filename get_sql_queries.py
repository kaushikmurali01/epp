...
def get_outlier_summary(facility_id, factor, independent_variable):
    return outlier_summary.format(facility_id, factor, factor, facility_id, independent_variable)


def get_observed_data_summary(facility_id, factor, independent_variable):
    return observed_data_summary.format(facility_id, factor, factor, facility_id, independent_variable)
