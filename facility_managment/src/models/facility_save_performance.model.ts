...
export interface IFacilitySavePerformance {
  id: number | null;
...
class FacilitySavePerformance
  extends Model<IFacilitySavePerformance>
  implements IFacilitySavePerformance
{
...
FacilitySavePerformance.init(
  ...
  {
    sequelize,
    tableName: "facility_save_performance",
    timestamps: true,
    underscored: true,
    modelName: "FacilitySavePerformance",
  }
);

export { FacilitySavePerformance };

FacilitySavePerformance.belongsTo(User, {
