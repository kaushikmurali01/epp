...
interface FacilityCreationAttributes
  extends Optional<IFacilityAttributes, "id"> {}

class Facility
  extends Model<IFacilityAttributes, FacilityCreationAttributes>
  implements IFacilityAttributes
{
  public id!: number;
