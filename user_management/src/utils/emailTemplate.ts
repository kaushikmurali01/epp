export class EmailTemplate {
                ...
                <td style="padding: 0;">
                  <table style="
                    ...
                    <tr style="background: #FFF;">
                      <td style="width: 1.5rem;"></td>
                      <td>
                        <img src="https://eppdevstorage.blob.core.windows.net/assets/new_logo.png" alt="mailer-bg"
                          class="mail-bg" style="display: block; max-width:100%" />
                      </td>
                      <td style="width: 1.5rem;"></td>
                    </tr>
                    <tr style="background: #FFF;">
                        ...
                        <table style="
                          ...
                          <tr>
                            <td class="common-para" style="
                              ...
                              assistance.<br />
                              <!-- <a href="#"
                                      style="text-decoration: none; color: #2C77E9; font-size: 0.875rem; font-weight: 500; font-style: italic;">dummycontactsupport@enerva.com</a> -->
                            </td>
                          </tr>
                          <tr>
                            <td style="height: 1.25rem"></td>
                          ...
                          <tr>
                            <td class="common-para" style="
                                     ...
                                     font-weight: 400;
                                     ">
                              <b style="font-weight: 500;">Customer Service Contact Information:</b><br />
                              Phone Number: <b style="font-weight: 500;">1-888-852-2440</b> <br />
                              Email: <a href="#"
                                style="text-decoration: none; color: #2C77E9; font-size: 0.875rem; font-weight: 500; font-style: normal;">info@energyperformanceprogram.ca</a>
                            </td>
                          </tr>
                          <tr>
                            <td style="height: 1.25rem"></td>
                          ...
                          <tr>
                            <td style="height: 0.25rem"></td>
                          </tr>
                          <tr>
                            <td><i style="opacity: 0.5; font-size: 10px;">Please do not reply to this message. This email
                              address is not monitored so we are unable to respond to any messages
                              sent to this address.</i></td>
                          </tr>
                        </table>
                      </td>
                      <td style="width: 1.5rem;"></td>
    ...
    static async getEmailTemplate_old() {
